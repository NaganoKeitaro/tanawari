...
const PRODUCT_NAMES: Record<string, string[]> = {
    '焼肉セット': ['特選カルビセット', '和牛ロースセット', 'ファミリー焼肉セット', 'プレミアム焼肉盛り', 'お手軽BBQセット'],
    '精肉': ['黒毛和牛サーロイン', '国産豚ロース', '鶏もも肉', '牛バラ切り落とし', '豚バラブロック'],
    '鮮魚': ['本マグロ赤身', 'サーモン刺身', 'ブリ切り身', 'カツオたたき', 'アジ開き'],
    '野菜': ['レタス', 'トマト', 'きゅうり', 'キャベツ', 'にんじん'],
    '果物': ['りんご', 'バナナ', 'みかん', 'ぶどう', 'いちご'],
    '惣菜': ['唐揚げ', 'コロッケ', 'とんかつ', '肉じゃが', 'ポテトサラダ'],
    '乳製品': ['牛乳1L', 'ヨーグルト', 'バター', 'チーズ', '生クリーム'],
    '飲料': ['緑茶500ml', 'ミネラルウォーター', 'コーラ', 'オレンジジュース', 'コーヒー'],
    'パン': ['食パン', 'クロワッサン', 'あんぱん', 'カレーパン', 'フランスパン'],
    '菓子': ['ポテトチップス', 'チョコレート', 'クッキー', 'せんべい', 'グミ'],
    '調味料': ['醤油', '味噌', 'サラダ油', '塩', '砂糖'],
    '冷凍食品': ['冷凍餃子', '冷凍うどん', 'アイスクリーム', '冷凍ピラフ', 'ミックスベジタブル']
};
